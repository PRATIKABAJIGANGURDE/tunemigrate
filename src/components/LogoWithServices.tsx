  ...
  return (
    <div className="flex items-center gap-2 md:gap-3 logo-animation">
      <div className="flex items-center">
        ...
        <motion.div 
          className="w-8 h-8 md:w-12 md:h-12 bg-gray-50 rounded-xl flex items-center justify-center shadow-md border border-gray-100"
        ...
        >
          <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 md:w-7 md:h-7" fill="#1DB954">
            <title>Spotify</title>
